...
export const HomeIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
...
export const UsersIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const SchoolIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 14L21 9L12 4L3 9L12 14ZM12 14L18.1591 10.5783C18.7017 11.9466 19 13.4384 19 15C19 15.3412 18.9896 15.6797 18.9694 16.0152M12 14L5.84085 10.5783C5.29826 11.9466 5 13.4384 5 15C5 15.3412 5.01038 15.6797 5.03062 16.0152M6 20.0872H18M9 21V17.5C9 16.1193 10.1193 15 11.5 15H12.5C13.8807 15 15 16.1193 15 17.5V21" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);

export const BookIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const ChartIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M9 19V10M15 19V14M3 21H21M12 19V6M18 19V12M6 19V14" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);

export const SettingsIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const EyeIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const ClipboardIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const HashIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M7 15L17 15M7 9L17 9M13 3L9 21M17 3L13 21" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);

export const QrCodeIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M3 7C3 5.89543 3.89543 5 5 5H7C8.10457 5 9 5.89543 9 7V9C9 10.1046 8.10457 11 7 11H5C3.89543 11 3 10.1046 3 9V7Z" stroke={color} strokeWidth="2"/>
    <Path d="M3 17C3 15.8954 3.89543 15 5 15H7C8.10457 15 9 15.8954 9 17V19C9 20.1046 8.10457 21 7 21H5C3.89543 21 3 20.1046 3 19V17Z" stroke={color} strokeWidth="2"/>
    <Path d="M15 7C15 5.89543 15.8954 5 17 5H19C20.1046 5 21 5.89543 21 7V9C21 10.1046 20.1046 11 19 11H17C15.8954 11 15 10.1046 15 9V7Z" stroke={color} strokeWidth="2"/>
    <Path d="M15 15H17M15 18H17M18 15H21M18 21H21M21 18H18H21Z" stroke={color} strokeWidth="2" strokeLinecap="round"/>
  </Svg>
);

export const GraduationIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 14L21 9L12 4L3 9L12 14ZM12 14L18.1591 10.5783C18.7017 11.9466 19 13.4384 19 15C19 15.3412 18.9896 15.6797 18.9694 16.0152M12 14L5.84085 10.5783C5.29826 11.9466 5 13.4384 5 15C5 15.3412 5.01038 15.6797 5.03062 16.0152M6 20.0872H18M9 21V17.5C9 16.1193 10.1193 15 11.5 15H12.5C13.8807 15 15 16.1193 15 17.5V21" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);

export const ScrollIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const BellIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const LogoutIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M17 16L21 12M21 12L17 8M21 12H7M13 16V17C13 18.6569 11.6569 20 10 20H6C4.34315 20 3 18.6569 3 17V7C3 5.34315 4.34315 4 6 4H10C11.6569 4 13 5.34315 13 7V8" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);

export const TeacherIcon: React.FC<IconProps> = ({ size = 20, color = '#000' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
