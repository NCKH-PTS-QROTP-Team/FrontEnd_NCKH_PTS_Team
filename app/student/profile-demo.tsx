...
export default function StudentDashboardExample() {
  return (
    <View style={{ flex: 1, backgroundColor: '#F9FAFB' }}>
      {/* Beautiful Header with Avatar, Name, and Notifications */}
      <AppHeader
        title="Trang chủ sinh viên"
        showUserProfile={true}
        userName="Nguyễn Thị Hương"
        userEmail="huong.nguyen@student.edu.vn"
        userRole="student"
          ...
          >
            ...
            <View style={{
              ...
              <Text style={{ fontSize: 14, color: '#374151', lineHeight: 21 }}>
                💡 <Text style={{ fontWeight: '600' }}>Hướng dẫn sử dụng:</Text> Click vào avatar/tên để xem menu profile. Click vào icon chuông để xem thông báo. Click bên ngoài hoặc ESC để đóng dropdown.
              </Text>
            </View>
          </View>
...
function ExampleCard({ icon, title, description, color }: { 
  icon: string; 
  title: string; 
  description: string; 
  color: string;
