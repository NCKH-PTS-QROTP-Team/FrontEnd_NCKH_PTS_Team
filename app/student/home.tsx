        ...
        >
          ...
          >
            ...
            <View style={{ width: isDesktop ? (Platform.OS === "web" ? "calc(60% - 12px)" : "58%") : "100%" }}>
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center", gap: 12, justifyContent: "space-between", width: "100%" }}>
                  <Text
                    style={{ fontSize: 16, fontWeight: "700", color: "#1e293b", flexShrink: 0 }}
                  >
                    Lịch học hôm nay
                  </Text>
                  {/* nút để chuyển sang schedule */}
                  <TouchableOpacity style={{}}>Xem chi tiết</TouchableOpacity>
                </View>
