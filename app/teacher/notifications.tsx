...
// ─── Notification config ──────────────────────────────────────────────────────
const NOTIF_CONFIG: Record<NotifType, { icon: string; color: string; bg: string; label: string }> = {
    attendance: { icon: "checkmark-circle", color: "#10b981", bg: "#ecfdf5", label: "Điểm danh" },
    warning: { icon: "warning", color: "#ef4444", bg: "#fef2f2", label: "Cảnh báo" },
    system: { icon: "settings", color: "#6366f1", bg: "#eef2ff", label: "Hệ thống" },
    info: { icon: "information-circle", color: "#3b82f6", bg: "#eff6ff", label: "Thông tin" },
};
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
                                            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                                                ...
                                                {!notif.read && (
                                                    <View style={{ width: 7, height: 7, borderRadius: 4, backgroundColor: "#6366f1" }} />
                                                )}
                                            </View>
                                            <TouchableOpacity
