    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            <View style={styles.header}>
                <Text style={styles.title}>Import dữ liệu</Text>
                <Text style={styles.subtitle}>Chọn loại dữ liệu bạn muốn import từ file Excel</Text>
            </View>
            ...
            <View style={styles.guidanceBox}>
                ...
                <View style={styles.guideContent}>
                    <Text style={styles.guideItem}>• File Excel phải đúng định dạng (.xlsx hoặc .xls)</Text>
                    <Text style={styles.guideItem}>• Dòng đầu tiên là header, các dòng tiếp theo là dữ liệu</Text>
                    <Text style={styles.guideItem}>• Kiểm tra kỹ dữ liệu trước khi import để tránh lỗi</Text>
                    <Text style={styles.guideItem}>• Hệ thống sẽ báo cáo chi tiết các dòng lỗi sau khi import</Text>
                </View>
            </View>
                    ...
                    <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>
                                {selectedOption === 'classes' ? 'Import lớp học' : 'Import sinh viên'}
                            </Text>
                        ...
                        <View style={styles.uploadArea}>
                            ...
                            <Text style={styles.uploadText}>Nhấn để chọn file hoặc kéo thả file vào đây</Text>
                            <Text style={styles.uploadSubtext}>Chỉ hỗ trợ file .xlsx, .xls</Text>
